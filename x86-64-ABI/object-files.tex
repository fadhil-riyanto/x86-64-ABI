...
\Hrule
  ...
  \begin{center}
    \begin{tabular}[t]{l|r|l|l}
      ...
      \texttt{R_X86_64_REX2_GOTTPOFF} & 44 & \textit{word32} &  \\
      \texttt{R_X86_64_REX2_GOTPC32_TLSDESC} & 45 & \textit{word32} &  \\
     \cline{1-4}
...
Storage''\footnote{This document is currently available via
  ...
  Storage}.  \texttt{R_X86_64_REX2_GOTTPOFF} should be generated,
instead of \texttt{R_X86_64_GOTTPOFF}, if the \code{RE2} prefix is present
and linker optimization must take the \code{REX2} prefix into account.
...
\texttt{R_X86_64_REX_GOTPC32_TLSDESC} should be generated, instead of
\texttt{R_X86_64_GOTPC32_TLSDESC}, if the \code{RE2} prefix is present
and linker optimization must take the \code{REX2} prefix into account.
\end{sloppypar}
